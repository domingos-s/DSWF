...
.recognition-log-section{margin:-14px 0 34px;width:100%;max-width:100%;min-width:0;overflow:hidden}.recognition-log-heading{display:flex;align-items:end;justify-content:space-between;gap:12px;margin:0 2px 10px;min-width:0}.recognition-log-heading>div{min-width:0}.recognition-log-heading h3{margin:0;font-size:18px;letter-spacing:-.025em}.recognition-log-heading .eyebrow{margin-bottom:3px}.recognition-log-list{display:grid;gap:8px;width:100%;max-width:100%;min-width:0}.recognition-log-row{background:var(--card);border:1px solid var(--line);border-radius:17px;padding:13px;width:100%;max-width:100%;min-width:0;overflow:hidden}.recognition-log-main{display:flex;align-items:center;gap:11px;min-width:0;max-width:100%}.recognition-log-avatar{flex:0 0 auto}.recognition-log-avatar>span{width:40px;height:40px;border-radius:50%;background:#fff5c9;display:grid;place-items:center}.recognition-log-copy{min-width:0;max-width:100%;flex:1;overflow:hidden}.recognition-log-title{display:flex;align-items:baseline;justify-content:space-between;gap:10px;min-width:0}.recognition-log-title strong{font-size:14px;min-width:0}.recognition-log-title span{font-size:10px;color:var(--muted);white-space:nowrap;flex:0 0 auto}.recognition-log-detail{font-size:11px;color:var(--muted);margin-top:3px;display:flex;gap:5px;min-width:0;max-width:100%}.recognition-log-detail b{color:var(--ink);font-weight:800;white-space:nowrap;flex:0 0 auto}.recognition-log-detail span{min-width:0;max-width:100%;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.recognition-log-status{display:inline-flex;align-items:center;max-width:calc(100% - 51px);margin:10px 0 0 51px;border-radius:999px;padding:5px 8px;font-size:10px;font-weight:850;background:#fff4bd;color:#725d10}.recognition-log-modal .recognition-log-row{background:#fff}.recognition-log-modal .recognition-log-list{margin-top:18px}.recognition-log-modal .recognition-log-detail span{white-space:normal;overflow:visible;text-overflow:clip;overflow-wrap:anywhere}@media(max-width:520px){.recognition-log-section{margin-top:-14px}.recognition-log-title{display:block}.recognition-log-title span{display:block;margin-top:1px}.recognition-log-status{margin-left:51px}.recognition-log-detail{display:block}.recognition-log-detail b{display:block;margin-bottom:1px;white-space:normal}.recognition-log-detail span{display:block;width:100%;max-width:100%;white-space:normal;overflow:visible;text-overflow:clip;overflow-wrap:anywhere;word-break:break-word;line-height:1.35}}
`;
