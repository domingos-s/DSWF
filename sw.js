const CACHE='dswf-v10';
const ASSETS=['./','./index.html','./styles.css','./journal.css','./insights.css','./app.js','./journal.js','./insights.js','./insights-extra.js','./leaderboard.js','./version.js','./manifest.webmanifest','./icons/icon.svg'];
