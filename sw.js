const CACHE='dswf-v5';
const ASSETS=['./','./index.html','./styles.css','./journal.css','./insights.css','./app.js','./journal.js','./insights.js','./insights-extra.js','./version.js','./manifest.webmanifest','./icons/icon.svg'];
